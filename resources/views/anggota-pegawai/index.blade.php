                        ...
                        <div class="d-flex">
                            <div class="dropdown mo-mb-2 mr-3">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{route('anggota.export.pdf',['role'=>'Pegawai'])}}" target="blank">Pdf</a>
                                    <a class="dropdown-item" href="{{route('card.index',['role'=>'Pegawai'])}}" target="blank">Kartu</a>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#myTable').DataTable({
                ...
                processing:true,
                serverSide:true,
                ajax:"{{route('anggota-pegawai.index')}}",
                columns:[
